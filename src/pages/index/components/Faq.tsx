...
const SectionHeader = ({ title }: { title: string }) => (
  <div className="relative">
    <h2 className="text-4xl font-light bg-gradient-to-l from-[#2C418F] to-[#4B70F5] text-transparent bg-clip-text">
      {title}
    </h2>
  </div>
);
    ...
    <div className=" border-[#737373] border-b   transition-all duration-200">
      ...
      >
        ...
        <div className="flex-1">
          ...
          {isOpen && (
            <p className="mt-3 text-gray-600 bg-[#EAEFFF] leading-relaxed rounded-4xl py-3 px-5 border-l border-[#4B70F5]">
              {answer}
            </p>
          )}
        </div>
    ...
    <div className="hero w-full h-auto mx-auto py-16 px-6">
      <div className="text-center space-y-8 mb-12">
        ...
        <p className="text-gray-600 mt-8 max-w-2xl mx-auto">
          Need help? Check out our most commonly asked questions below. If you
          can't find what you're looking for, reach out to our support team at{" "}
          <a
            href="mailto:support@hovertask.com"
