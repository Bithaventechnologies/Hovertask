...
const SectionHeader = ({ title }: { title: string }) => (
  <p className="text-3xl bg-gradient-to-l from-[#2C418F] to-[#4B70F5] text-transparent bg-clip-text">
    {title}
  </p>
);
    ...
    <div className="hero w-full h-auto">
      ...
      <div className="w-full h-[50vh] flex justify-center items-center max-md:h-[70vh]">
        <div className="w-[80%] h-[60%] max-md:h-[90%] bg-[#e9edfe] flex justify-center items-center text-center rounded-4xl px-8 transform rotate-[-2deg]">
          <p className="text-xl font-light max-md:text-lg">
            Welcome to Hovertask, your trusted platform for earning and
            advertising! At Hovertask, we connect businesses with individuals
            who are ready to perform simple social media tasks, advertise
            products, and help brands grow. Our mission is to create
            opportunities for people to earn daily income while helping
      ...
      <div className="w-full h-[70vh] flex justify-center gap-14 max-md:gap-0 items-center max-md:flex-col max-md:h-[90vh]">
        ...
        <div className="w-[32%] h-[47%] flex flex-col justify-center gap-3 px-3 max-md:w-[80%] max-md:h-[60%]">
          <p className="bg-gradient-to-r from-[#4B70F5] to-[#2C418F] text-transparent bg-clip-text text-7xl font-light max-md:text-6xl">
            Our Mission
          </p>
          <p className="font-light">
            To empower individuals by providing them with easy, flexible ways to
            earn and to support businesses in achieving their marketing goals
      ...
      <div className="w-full flex justify-around flex-col items-center h-[70vh] px-12 max-md:h-[90vh] max-md:px-0">
        <div className="w-full h-[40%] px-3">
          ...
          <GradientBox>
            <RiGogglesLine
              size={100}
              className="text-[#4B70F5] max-md:size-[150px]"
            />
            <p className="text-light">
              To become the leading platform for micro-jobs, advertising, and
              product reselling in the digital space, empowering millions of
              users globally.
            </p>
          </GradientBox>
        </div>
        <div className="w-full h-[40%] flex justify-start items-end flex-col px-2">
          ...
          <GradientBox>
            ...
            />
            <p className="text-light">
              Hovertask is powered by a team of dedicated professionals who are
              passionate about creating opportunities for individuals and
              businesses.
            </p>
          </GradientBox>
        </div>
      ...
      <div className="w-full flex items-center justify-center  gap-5 mt-10 max-md:flex-col">
        ...
        <div className="w-[50%] flex flex-col gap-4 max-md:w-full">
          <p className="text-lg flex items-center gap-2  max-md:text-center">
            <LuDot className="text-[#4B70F5]" size={22} />
            <span className="font-bold text-[#4B70F5] ">Transparency:</span> We
            ensure honesty and clarity in all transactions.
          </p>
          <p className="text-lg flex items-center gap-2 max-md:text-center">
            <LuDot className="text-[#4B70F5]" size={22} />
            <span className="font-bold text-[#4B70F5]">Innovation:</span> We
            continuously improve to serve you better.
          </p>
          <p className="text-lg flex items-center gap-2 max-md:text-center">
            <LuDot className="text-[#4B70F5]" size={22} />
            <span className="font-bold text-[#4B70F5]">Empowerment:</span> We
            aim to uplift individuals and businesses alike.
          </p>
          <p className="text-lg flex items-center gap-2 max-md:text-center">
            <LuDot className="text-[#4B70F5]" size={22} />
            <span className="font-bold text-[#4B70F5]">Community:</span> We are
            building a network where everyone can thrive together.
          </p>
          {/* Buttons */}
          <div className="mt-8 flex gap-4">
            <button className="px-6 py-2 bg-[#4B70F5] text-white rounded-lg shadow-md hover:bg-[#2C418F] transition">
              Create Account
            </button>
            <button className="px-6 py-2 border border-[#4B70F5] text-[#4B70F5] rounded-lg shadow-md hover:bg-[#4B70F5] hover:text-white transition">
              Login your Account
            </button>
          </div>
        </div>
