...
const HowToUseSection = () => {
  return (
    <div className="bg-white p-10 rounded-lg  flex flex-col items-center text-center max-w-3xl mx-auto">
      ...
      <p className="text-gray-600 mb-6">
        Whether you're an Earner or an Advertiser, getting started is simple!
        Follow these easy steps to achieve your goals.
      </p>
