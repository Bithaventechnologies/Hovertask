...
import logo from "../assets/brand-logo.svg"; // Update path
    ...
    return (
        <footer className="bg-gradient-to-r from-[#4B70F5] to-[#2C418F] text-gray-200 py-12">
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <p className="text-sm leading-relaxed">
                        Our mission is to create income opportunities for people to earn daily while helping businesses
            ...
            <div className="mt-12  pt-6 text-center">
                ...
                <p className="text-sm mt-4">&copy; {new Date().getFullYear()} Hovertask. All rights reserved.</p>
            </div>
        </footer>
    );
};
