...
const DashboardNav: React.FC<DashboardHeaderProps> = ({ activeNav, setActiveNav, openDropdown, setOpenDropdown }) => {
    const adds = [
        {
            imgSrc: phone,
                    ...
                    {navList.map((nav, index) => (
                        <div key={index}>
                            <Link
                                ...
                                className={`${
                                    activeNav === nav.label ? "bg-white  text-[#7390f7]" : "text-white"
                            ...
                            {openDropdown &&
                                nav.options?.map((option, index) => (
                                    <Link
                                        ...
                                        className={`${
                                            activeNav === option.label ? "bg-white  text-[#7390f7]" : "text-white"
            ...
            <div className=" lg:w-full hidden lg:block">
                {adds.map((add, index) => (
                    <div className="relative">
                        <div key={index} className="p-6 mt-5 border  border-gray-300 custom-clip rounded-[20px]">
