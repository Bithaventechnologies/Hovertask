...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({activeNav  , setActiveNav, openDropdown, setOpenDropdown}) => {
                  ...
                  <div className="flex flex-col" key = {index}>
                    ...
                    >
                      {nav.icon ? (
                        ...
                        <img src={nav.imgSrc} alt={nav.label} />
                      )}
                      <span>{nav.label}</span>
